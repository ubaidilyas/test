...
az storage file exists -s cost-reports -p test/test_ubaid.txt --account-key $secret --account-name mondiaci
az storage file exists -s cost-reports -p test/test_ubaid1.txt --account-key $secret --account-name mondiaci